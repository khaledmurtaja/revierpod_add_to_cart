...
class CartScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Scaffold(
      ...
      body: cart.isEmpty ? _buildEmptyCart() : _buildCartContent(cart, ref, context),
    );
  }
  ...
  void _showCheckoutDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: const Text('Thank you for your order! This is a demo app, so no actual payment will be processed.'),
        actions: [
          TextButton(
            onPressed: () => Navigator.of(context).pop(),
            child: const Text('OK'),
